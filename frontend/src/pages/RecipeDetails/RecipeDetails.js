...
export default function RecipeDetails() {
    ...
    let recipeDetailsArray = recipesList.filter((recipe) => recipe.id == recipeId);
              ...
              <div className='mt-5 text-center'>
                  ...
                  <div className='mt-4 d-flex justify-content-center'>
                      <div style={{ width: 100, height: 100 }} className='me-4'>
                          <CircularProgressbar value={recipeDetails.recipeNutrition.Calories} text={`${recipeDetails.recipeNutrition.Calories}%`} />
                          <div className='fw-bold fs-5'>Calories</div>
                      </div>
                      <div style={{ width: 100, height: 100 }} className='me-4'>
                          <CircularProgressbar value={recipeDetails.recipeNutrition.Fat} text={`${recipeDetails.recipeNutrition.Fat}%`} />
                          <div className='fw-bold fs-5'>Fat</div>
                      </div>
                      <div style={{ width: 100, height: 100 }} className='me-4'>
                          <CircularProgressbar value={recipeDetails.recipeNutrition.Protein} text={`${recipeDetails.recipeNutrition.Protein}%`} />
                          <div className='fw-bold fs-5'>Protien</div>
                      </div>
                      <div style={{ width: 100, height: 100 }} className='me-4'> 
                          <CircularProgressbar value={recipeDetails.recipeNutrition.Manganese} text={`${recipeDetails.recipeNutrition.Manganese}%`} />
